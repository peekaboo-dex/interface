...
function useLocalStorage<T>(key: string, parseFn?: (value: string) => T) {
  const [value, _setValue] = useState<T | null | undefined>(undefined)
  ...
  return [value, setValue, hasRead] as const
}
